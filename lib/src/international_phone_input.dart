...
class InternationalPhoneInput extends StatefulWidget {
  ...
  final Widget defaultCountryFlag;
...
class _InternationalPhoneInputState extends State<InternationalPhoneInput> {
  ...
  void initState() {
   ...
   void dispose(){
    phoneTextController.removeListener(_validatePhoneNumber);
                  ...
                  return DropdownMenuItem<Country>(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          if (showCountryFlags) ...[
                            value.code.toLowerCase()=='in'?(widget.defaultCountryFlag!=null ?
                            widget.defaultCountryFlag:
                            Image.asset(
                              value.flagUri,
                              width: 32.0,
